...
import { LayoutDashboard, Users, FileText, Globe } from 'lucide-react'
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-56 bg-white border-r border-gray-100 flex flex-col z-50 shadow-sm">

      {/* Logo */}
      <div className="px-5 py-5 border-b border-gray-100">
        <Link href="/bigbos" className="flex items-center gap-2.5">
